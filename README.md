...
### הבעיה
Supabase בתוכנית החינמית משהה את הדאטהבייס אחרי 7 ימים בלי פעילות. אם אף אחד לא נכנס לאתר שלכם במשך שבוע — הדאטהבייס נכבה והאתר קורס.

### הפתרון
יצרנו מערכת אוטומטית שמונעת את זה:

1. **נקודת API** — כתובת באתר שכשמישהו פונה אליה, היא שולחת שאילתה קלה לדאטהבייס. Supabase רואה פעילות ולא משהה.
2. **סיסמה (טוקן)** — מגנה על הכתובת כדי שרק אנחנו נוכל לקרוא לה.
3. **תהליך אוטומטי (GitHub Actions)** — כל 3 ימים שולח בקשה לכתובת הזו בלי שנצטרך לעשות משהו.

### התוצאה
אפס עלות. אפס תחזוקה. הדאטהבייס תמיד ער.
